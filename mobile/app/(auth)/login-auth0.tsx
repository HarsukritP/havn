 ...
 * 
 * This is a simpler login experience that uses Auth0's Universal Login.
 * Users will be redirected to Auth0's hosted login page in a web browser.
 * 
 * To use this instead of the current Supabase login:
 * 1. Rename this file to `login.tsx`
 * 2. Rename the old `login.tsx` to `login-supabase.tsx`
 * 3. Configure your Auth0 credentials in mobile/config/auth0.ts
 */

function LoginAuth0Screen() {
...
LoginAuth0Screen.displayName = 'LoginAuth0Screen';

export default LoginAuth0Screen;
